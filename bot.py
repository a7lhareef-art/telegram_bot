...
# ======================================================
# 1. الإعدادات (ضع التوكن الجديد هنا)
# ======================================================
BOT_TOKEN = "8315190785:AAF9WVznr23Xdq4G_gNpHdz-um8B49SyeIk"  # غيره للتوكن الجديد
ADMIN_ID = 8933825471
...
async def button_handler(update: Update, context):
    ...
    if data.startswith("cat_"):
        await query.edit_message_text(
            f"⏳ **قيد التطوير**\n\n"
            f"هذا القسم سيتم إضافته قريباً.\n"
            f"🔹 شكراً لصبرك!",
            parse_mode='Markdown'
        )
        return
