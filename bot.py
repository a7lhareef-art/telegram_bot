...
if not BOT_TOKEN:
    # إذا لم يوجد، نعطي رسالة واضحة ونوقف التنفيذ
    logging.critical("❌ لم يتم العثور على BOT_TOKEN في متغيرات البيئة!")
    logging.critical("يرجى تعيين المتغير BOT_TOKEN في Railway أو أي منصة استضافة.")
    raise ValueError("❌ BOT_TOKEN مش موجود في Variables!")

# ==================== الإعدادات الأساسية ====================
ADMIN_ID = int(os.environ.get("ADMIN_ID", 8933825471))  # ضع معرفك هنا أو في المتغيرات
